...
import com.cg.pta.CountDownTimer;
...
import com.cg.pta.Score;
import static com.jogamp.opengl.GL2ES3.GL_QUADS;
import com.jogamp.opengl.util.awt.TextRenderer;
import com.jogamp.opengl.util.texture.Texture;
import com.jogamp.opengl.util.texture.TextureCoords;

public class Car2 implements ISimpleObject {
	private float pX;
	private float pZ;
	private float desX;
	private float desZ;
	private float pDefaultSpeed = 0.3000000000000000000000f;
	...
	private static String trashURL = "/fx/money.wav";
	...
	public Car2(boolean[][] mazeGrid, Texture[] textures, List<Money> money) {
		pX = 0f;
		pZ = 0f;
		desX = pX;
		desZ = pZ;
	...
	public void updateMoneyCollision() {
